...
export const calculatedFields: CalculatedField[] = [
  ...
  { id: "taxaUtilizacaoVM", label: "Taxa Utilização VM (%)", formula: "(utilização VM / paciente dia total) × 100" },
  { id: "taxaInfeccaoVM", label: "Taxa Infecção VM / PAV (‰)", formula: "(infecção VM / utilização VM) × 1000" },
  { id: "taxaUtilizacaoSVD", label: "Taxa Utilização SVD (%)", formula: "(utilização SVD / paciente dia total) × 100" },
